...
Testing
    ...
    #set selenium implicit wait -> Implicit wait specifies the maximum time how long Selenium waits when searching for elements
    Set Selenium Implicit Wait    10

    #fill in data to register
    Select Radio Button    Gender    ${gender}
    Input Text    id:FirstName11    Firsname 01
